<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,19,24,25,30&height=200&section=header&text=Aman%20Sah&fontSize=72&fontAlign=50&fontAlignY=38&fontColor=ffffff&desc=Full%20Stack%20%26%20AI%20Engineer&descAlign=50&descAlignY=58&descSize=22&animation=fadeIn" width="100%"/>
</p>
...
<p align="center">
  ...
  <a href="mailto:sah99017@gmail.com">
    <img src="https://img.shields.io/badge/Gmail-sah99017@gmail.com-5B21B6?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  &nbsp;
...
Deeply invested in the intersection of **software engineering and artificial intelligence** — designing conversational agents, integrating OpenAI/Gemini APIs, and automating complex workflows with n8n. Strong product engineering mindset with emphasis on developer experience, API design, and clean code standards.
...
Architected and delivered the complete platform from schema design to deployment — including multi-vendor onboarding flows, product listing management, order lifecycle pipelines, and an AI recommendation layer that injects LLM context into product ranking. Built real-time vendor dashboards tracking sales velocity, inventory levels, and fulfilment status via dynamic data visualizations.
...
| **Auth** | JWT + OTP verification · bcrypt · Role-based access (Student / Instructor / Admin) |
...
Implemented a complete content commerce pipeline — multi-role authentication, instructor-side content creation tools, student enrolment flows, and payment processing. Built with Redux for global state management and Cloudinary for all media asset operations.
...
Engineered a stateless Cloudinary image upload pipeline via Multer buffer piping and a Nodemailer SMTP service that auto-dispatches contact notifications and personalised visitor confirmation emails. Full project CRUD via a protected admin dashboard.
...
Designed an Express.js middleware-based role guard system protecting API routes by verifying JWT claims, paired with a React Auth Context managing client-side route guards and redirect flows. Prevents XSS token theft through HTTPOnly cookie storage.
...
MongoDB Atlas tracks all file records across upload sessions. Nodemailer integration dispatches upload confirmation notifications. Cloudinary handles all media storage, transformation, and CDN delivery.
...
> A production-deployed conversational AI agent on WhatsApp automating the full doctor appointment booking lifecycle — inquiry to confirmation to reminder.
...
| **Scale** | Handles concurrent patient queries with stateful multi-step dialogue management |

Designed intelligent multi-step n8n workflows that parse natural language queries, perform real-time slot availability checks against booking systems, confirm appointments, and dispatch automated reminders — removing the need for any human-in-the-loop scheduling.
...
Embedded in a 5-person Agile engineering team, contributing to sprint planning, stand-ups, and peer code reviews. Responsible for enforcing coding standards, managing Git feature-branch workflows, and maintaining clean PR histories.

- Architected and delivered a multi-vendor e-commerce platform with Next.js and PERN stack
- Integrated LLM-based product recommendation APIs into the platform's discovery layer
...
![LLM](https://img.shields.io/badge/LLM%20Integration-7C3AED?style=flat-square&logo=openai&logoColor=white)
![Agile](https://img.shields.io/badge/Agile%20%2F%20Scrum-6D28D9?style=flat-square)
![Git](https://img.shields.io/badge/Git%20Workflows-F05032?style=flat-square&logo=git&logoColor=white)
...
| **LLM Engagement Uplift** | ~35% simulated increase in user engagement from AI-powered product recommendations |
| **CGPA 8.0 / 10.0** | B.Tech Computer Science Engineering · Jain University · Graduated Nov 2025 |
| **Live Portfolio** | Production-deployed full-stack portfolio with AI chatbot assistant at amansah.com.np |
| **24/7 AI Agent** | Deployed autonomous appointment booking agent processing patient queries without human intervention |
...
learning:
  ...
  - TypeScript at scale — strict mode, advanced generics, utility types

building:
  - Multi-vendor e-commerce platform @ SolutionPath Technology
  - AI-integrated personal projects leveraging OpenAI and Gemini APIs
...
open_to:
  ...
  - Open source collaboration on developer tools and infrastructure
```
...
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,19,24,25,30&height=120&section=footer&animation=fadeIn" width="100%"/>
</p>
